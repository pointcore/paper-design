...
- **Symbols**: Named definitions behind hidden keepers (undo/save-safe), place instances, swap selected instances to another definition (position/rotation/scale carry over), delete definitions (instances keep working), break links back to plain art, per-symbol instance counts.
