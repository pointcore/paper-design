...
Not yet implemented: pattern fills, mesh gradients, opacity masks, multiple artboards, PDF export, brush/scissors tools, symbols, and multi-fill/stroke appearance stacks.
